...
// Name returns a human friendly name for the word given as a normalized string..
...
var shortWordToName = map[string]string{
	"G0":  "Rapid",
	"G1":  "Feed Rate",
	"G2":  "Arc CW",
	"G3":  "Arc CCW",
	...
	"G21": "Millimeters",
	// "G33":   "Spindle Synchronized Motion",
	"G38.2": "Toward Piece with Error",
	"G38.3": "Toward Piece",
	"G38.4": "From Piece With Error",
	"G38.5": "From Piece",
	"G40":   "Off",
	// "G41":   "Cutter Compensation Left",
	// "G42":   "Cutter Compensation Right",
...
// Name returns a short human friendly name for the word given as a normalized string..
func ShortWordName(word string) string {
	if name, ok := shortWordToName[word]; ok {
		return name
	}
	return word
}
