...
var responseMessageErrStr = map[ErrResponseMessage]string{
...
type ErrResponseMessage int

//gocyclo:ignore
func (e ErrResponseMessage) Error() string {
	if str, ok := responseMessageErrStr[e]; ok {
		return str
	}
	return fmt.Sprintf("unknown (%d)", e)
}

func (e ErrResponseMessage) ResponseMessage() *ResponseMessage {
	return &ResponseMessage{
		Message: fmt.Sprintf("error:%d", e),
	}
}
